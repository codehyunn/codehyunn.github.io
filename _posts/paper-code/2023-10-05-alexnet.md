---
title: "[AlexNet with PyTorch] ImageNet Classification with Deep Convolutional Neural Networks"
header:
...
와우 ·ࡇ·  <br>성능이 너무 별로여서 깜짝 놀랐다. 에포크 수가 너무 적었던 걸까?<br>조금 당황스러웠지만 그래도 구현을 해봤다는 점에 의의를 두기로 했다.
